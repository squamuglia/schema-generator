...
function generateSchema(inputFilename, outputFilename) {
    return __awaiter(this, void 0, void 0, function () {
        var schemaJson, sdl;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    schemaJson = JSON.parse(fs_1.default.readFileSync(inputFilename, 'utf8'));
...
function run() {
    return __awaiter(this, void 0, void 0, function () {
        var _a, inputFilename, outputFilename;
            ...
            switch (_b.label) {
                case 0:
                    commander_1.program
                        ...
                        .option('-i, --input-filename <fileName>', 'Path to file to be parsed. Should be appened with .json')
                        .option('-o, --output-filename <fileName>', 'Name of file to be output. Should be appended with .gql')
                        .parse(process.argv);
                    _a = commander_1.program.opts(), inputFilename = _a.inputFilename, outputFilename = _a.outputFilename;
                    if (!inputFilename || !outputFilename) {
                        return [2 /*return*/, commander_1.program.help()];
                    }
                    return [4 /*yield*/, generateSchema(inputFilename, outputFilename)];
                case 1:
                    _b.sent();
                    return [2 /*return*/];
            }
